...
<template>
  <div class="student-modal-overlay">
    <div class="student-modal-container">
      <<<<<<< HEAD <div class="flex items-center justify-between bg-[#494c6b] p-3 text-white">
        =======
        <div class="flex justify-between items-center bg-[#494c6b] text-white p-3">
          >>>>>>> d2e15d82a1bfa93ee8a27f13fc220ac79f49fcc1
          <h2 class="text-lg font-medium">학생 상세</h2>
          <button class="text-2xl">×</button>
        </div>
        <div class="p-4">
          <div class="mb-4">
            <<<<<<< HEAD <h3 class="mb-2 font-medium">학생 정보</h3>
                ...
                <table class="w-full border-collapse table-auto">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <<<<<<< HEAD <td class="student-modal-table-td">
                        ...
                        <th class="student-modal-table-th">재학 상태</th>
                        <td class="student-modal-table-td">{{ detail.statusYn === 'W' ? '승인 대기중' : detail.statusYn ===
                          'Y' ?
                          '재학' : '탈퇴' }}
                          >>>>>>> d2e15d82a1bfa93ee8a27f13fc220ac79f49fcc1
                        </td>
